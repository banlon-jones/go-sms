...
<div class="card">
    ...
    <div class="card-body px-lg-5">
        ...
        <!-- Form -->
        <form method="post" action="{{ route('notifications.store') }}" style="color: #757575;">
          {{ csrf_field() }}
            <div class="md-form mt-3">
                <input type="text" id="header" class="form-control" name="subject">
            ...
            <!-- Material switch -->
              <div class="switch">
                message type :
                <label>
                  <input type="checkbox" name="type" value="sms" checked>
